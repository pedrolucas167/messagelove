    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-6 animate-scaleIn">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Compartilhar Carta</h2>
          <p className="text-gray-500 text-sm mt-1">Envie sua carta para quem você ama</p>
        </div>

        {/* QR Code */}
        <div className="flex flex-col items-center mb-6">
          <div className="bg-white p-4 rounded-2xl shadow-lg border-2 border-pink-100 mb-3">
            {qrCodeUrl ? (
              <Image 
                src={qrCodeUrl} 
                alt="QR Code" 
        ...
        {/* Copy Link */}
        <div className="mb-6">
          <label className="text-sm font-medium text-gray-700 mb-2 block">Link da carta</label>
        ...
        <div className="space-y-3">
          <p className="text-sm font-medium text-gray-700">Compartilhar via</p>
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-black text-white rounded-xl hover:bg-gray-800 transition-colors font-medium"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-colors font-medium"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {typeof navigator !== "undefined" && navigator.share && (
          <button
            ...
            className="w-full mt-4 py-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-semibold rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
